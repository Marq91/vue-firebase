<template>
    <v-layout justify-center align-center>
        <v-flex xs12 sm8 md6 lg5 xl4>
            <v-card v-if="email" class="elevation-7">
                    ...
                    <v-card-text>
                        <v-layout justify-end>
                            <v-btn :drepressed="$v.f1.$invalid" :disabled="$v.f1.$invalid" @click="cambiarPassword" color="secondary">Aceptar</v-btn>
                        </v-layout>
                    </v-card-text>
            </v-card>
        </v-flex>
            ...
            switch (mode) {
                ...
                case 'resetPassword':
                    ...
                    try {
                        ...
                        this.mostrarError('No fue posible mostrar el codigo de restablecimiento de contraseña.')
                    }
                    finally {
                        this.ocultarOcupado()
                    }
